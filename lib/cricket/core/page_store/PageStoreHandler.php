...
interface PageStoreHandler {
    /** @return Page */
    function load($sessionID,$instanceID,$pageVersion);
    function save($sessionID,Page $inPage,$saveInstanceID = null);
    function gc($maxAgeInSeconds);
}